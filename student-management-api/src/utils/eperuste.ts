...
import type { MandatoryQualificationUnitsForTitle, QualificationCompetenceRequirement, QualificationCompetenceRequirements, QualificationTitle, QualificationUnit } from "prisma-orm";
